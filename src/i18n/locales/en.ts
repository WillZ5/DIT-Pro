...
const en = {
  ...
  settings: {
    ...
    cloudSyncDesc: "Automatically sync reports and thumbnails to cloud storage or NAS.",
    cloudEnabled: "Enable Auto-Sync",
    ...
    cloudRoot: "Remote Root Path",
    cloudSyncProxies: "Sync Proxy Files",
  ...
  mhlVerify: {
    title: "MHL Verify",
    subtitle: "Verify ASC MHL chain integrity and recompute media file hashes.",
    pathLabel: "MHL Folder or Manifest",
    pathPlaceholder: "Select a folder with ascmhl/ or a .mhl manifest...",
    selectFolder: "Select Folder",
    selectManifest: "Select MHL",
    verify: "Verify",
    verifying: "Verifying...",
    chainOnly: "Chain only",
    chainOnlyDesc: "Skip media file hashing and verify manifest references only",
    verifyAllGenerations: "Verify all generations",
    verifyAllGenerationsDesc: "Default verifies only the latest generation",
    generation: "Generation",
    generationPlaceholder: "Latest",
    resultPass: "PASS",
    resultFail: "FAIL",
    resultReady: "Ready",
    ...
    missing: "missing",
    errors: "errors",
    verifiedGenerations: "Verified generations",
    noIssues: "No issues detected",
    issuesTitle: "Verification Issues",
    issueKind: "Type",
    issueFile: "File",
    issueGeneration: "Gen",
    issueAlgorithm: "Algorithm",
